        ...
        <div className="wrapper">
          <div className="flex gap-x-[55px] mb-[55px]">
            ...
            <div className="w-full">
              <h1 className="text-[#C9AC8C] font-['Rotter'] text-[48px] mb-1">
                Qo’rqma
              </h1>
              ...
              <ul className="flex flex-col gap-y-5 text-[20px] mb-10">
                ...
                <li>
                  <span className="text-gray-400 me-1">Janri: </span> Tarixiy
                </li>
                <li>
                  <span className="text-gray-400 me-1">Nashriyot: </span> Nihol
                  nashr
                </li>
              </ul>

              <div className="flex  w-full items-center mb-[48px]">
                <p className="text-[#C9AC8C] text-[16px] w-[150px]">
                  To’liq ma’lumot
                </p>
              ...
              <p className="leading-[23px] text-[16px] mb-[46px]">
              ...
              <p className="text-[#C9AC8C] text-[16px] mb-[28px]">
                Mavjud formatlar
              </p>
          ...
          <ul className="flex items-center gap-x-[70px] mb-[50px]">
            ...
            <li>
              <a href="#">Kitobdan iqtiboslar</a>
            </li>
            <li>
              <a href="#">Kitobxonlar taqrizi</a>
            </li>
          </ul>
